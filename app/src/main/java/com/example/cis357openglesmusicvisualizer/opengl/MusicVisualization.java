...
public class MusicVisualization implements Runnable, TextureView.SurfaceTextureListener {
    ...
    private WaveForm mWaveFormFrame;
    private Frame mFFTFrame;
    private float[] mLastDbmArray;


    public MusicVisualization(Context context, int textureWidth) {
    ...
    public void updateWaveForm(WaveForm frame) {
